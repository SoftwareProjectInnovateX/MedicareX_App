  ...
  return (
    <View className="flex-1 bg-primary dark:bg-gray-900">
      ...
      <ScrollView className="flex-1 px-6 pt-6" showsVerticalScrollIndicator={false}>
        <Text className="text-2xl font-black text-textPrimary dark:text-white mb-4">Privacy Policy</Text>
        ...
        <Text className="font-bold text-lg text-textPrimary dark:text-white mb-2 mt-4">1. Information We Collect</Text>
        <Text className="text-textSecondary dark:text-gray-300 leading-6 mb-4">
        ...
        <Text className="font-bold text-lg text-textPrimary dark:text-white mb-2 mt-2">2. How We Use Your Information</Text>
