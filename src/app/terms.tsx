  ...
  return (
    <View className="flex-1 bg-primary dark:bg-gray-900">
      <View className="px-6 pt-14 pb-4 bg-white dark:bg-gray-800 border-b border-[#e5e7eb] dark:border-gray-700 flex-row justify-between items-center shadow-sm z-10">
        ...
        <Text className="text-xl font-bold text-textPrimary dark:text-white">Terms of Service</Text>
        <View className="w-10" />
      </View>
      <ScrollView className="flex-1 px-6 pt-6" showsVerticalScrollIndicator={false}>
        <Text className="text-2xl font-black text-textPrimary dark:text-white mb-4">Terms and Conditions</Text>
        <Text className="text-textSecondary dark:text-gray-300 leading-6 mb-4">
        ...
        <Text className="font-bold text-lg text-textPrimary dark:text-white mb-2 mt-4">1. Use of Service</Text>
        <Text className="text-textSecondary dark:text-gray-300 leading-6 mb-4">
        ...
        <Text className="font-bold text-lg text-textPrimary dark:text-white mb-2 mt-2">2. Prescriptions</Text>
        <Text className="text-textSecondary dark:text-gray-300 leading-6 mb-10">
